    ...
    , modeButtonGroup(new QButtonGroup(this))
{
    ...
    input->setTargetText("Это пример текста для тренировки слепой печати... Это пример текста для тренировки слепой печати... Это пример текста для тренировки слепой печати... Это пример текста для тренировки слепой печати... Это пример текста для тренировки слепой печати... Это пример текста для тренировки слепой печати... Это пример текста для тренировки слепой печати... Это пример текста для тренировки слепой печати... Это пример текста для тренировки слепой печати... Это пример текста для тренировки слепой печати...");
